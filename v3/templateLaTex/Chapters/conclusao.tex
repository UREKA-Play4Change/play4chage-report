...
As cinco direcções prioritárias de evolução decorrem directamente das limitações identificadas e do feedback recolhido junto dos participantes. A Tabela~\ref{tab:trabalho-futuro} organiza cada direcção em função do pilar afectado e da evidência que a motiva.
...
\textbf{Onboarding adaptado ao Grupo~B.} Tutoriais interactivos guiados ou versão simplificada da interface com navegação mais linear, que reduzam efectivamente a barreira de entrada sem infantilizar a experiência para o Grupo~A.
