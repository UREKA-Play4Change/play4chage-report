...
% FontAwesome5 icons used in architecture diagrams
\usepackage{fontawesome5}
% Force figures to stay exactly where placed in text
\usepackage{float}
...
% Allow LaTeX to stretch inter-word spacing slightly to avoid minor overfull hboxes
...
% Row with the two logos (ISEL and UREKA)
\noindent
\begin{minipage}{0.50\textwidth}
	\centering
	\includegraphics[height=2cm]{\@universitylogo}
\end{minipage}%
\begin{minipage}{0.50\textwidth}
	\centering
	\includegraphics[height=2cm]{UREKA}
\end{minipage}
