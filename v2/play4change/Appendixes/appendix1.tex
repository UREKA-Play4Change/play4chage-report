...
\section*{ADR-011: Estratégia de Autenticação}
Adoção de \textit{magic link} (SHA-256, Resend API) como mecanismo único de autenticação. Esta abordagem elimina a necessidade de palavra-passe, reduz a fricção de \textit{onboarding} e mantém a conformidade com as recomendações OWASP para fluxos de autenticação seguros.
...
Auditoria formal de segurança com identificação e correção de onze vulnerabilidades, cobrindo as categorias OWASP Top~10 relevantes para a plataforma.
