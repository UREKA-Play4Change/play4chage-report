...
\documentclass[
	...
	en,			% (*)pt, en - languages: report written in English
...
% Keyword separator for \keywords{} command
\newcommand{\sep}{, }
...
\hypersetup{ a4paper=true,
             ...
             pdfkeywords={adaptive learning, gamification, AI, sustainability, KMP, Kotlin}
             }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
