...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[font=\small]
    % Axes
    \draw[->] (0,0) -- (8.8,0) node[right] {\small Desafios Adaptativos};
    ...
    \node[font=\tiny\itshape, gray, align=center] at (2.0, 5.4)
      {Alta gamificação\\Baixos desafios adapt.};
    \node[font=\tiny\itshape, gray, align=center] at (6.5, 1.8)
      {Baixa gamificação\\Altos desafios adapt.};
    % Platform bubbles
  ...
  \end{tikzpicture}
  \caption{Mapa de posicionamento das plataformas (Gamificação vs.\ Desafios Adaptativos)}
