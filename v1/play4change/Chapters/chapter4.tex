...
\begin{itemize}
  ...
  \item \textbf{A07 --- Falhas de Identificação e Autenticação}: validação insuficiente de \textit{claims} nos fluxos OAuth; corrigida com verificação local via JWKS para Google OAuth e validação via Graph API para Facebook OAuth.
\end{itemize}
